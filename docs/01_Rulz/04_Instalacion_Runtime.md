...
3) Copiar el archivo adjunto [etc/selectividad-settings.xml](etc/selectividad-settings.xml) dentro del directorio [EAP_HOME]/standalone/configuration/
...
5) Crear el directorio ingresado: mkdir **/u02/jboss/data/selectividad**
